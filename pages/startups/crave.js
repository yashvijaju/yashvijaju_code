...
export default function Crave() {
    ...
    return(
        <>
            <Cover project_logo="/assets/projects/crave/logo.png" bookmark="/assets/bookmarks/bookmark-crave.svg"  bookmarkTitle="/assets/bookmarks/bookmark-crave-y.svg" bg_color={tertiary} title_color={secondary}></Cover>
