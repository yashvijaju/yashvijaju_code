    ...
    return(
        <div>
            <Hidden xsDown>
                ...
                <div style={{marginTop: '-7.5vh', display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
            ...
            <Hidden smUp>
                <Grid container direction="row" justify="center" style={{height: '50vh',  alignItems: 'center'}}>
                    <div className="col offset-l5" style={{'border': '2px solid #bee3f1', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>   
