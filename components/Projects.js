  ...
  return (
    <div style={{'padding': '5vh 0vw 2vh 0vw', backgroundColor: blue}}>
      ...
      <Grid container direction="row" justify="center" style={{padding: '0 4vw 0 4vw'}}>
        <Chip className="filterProjects" id="Featured" variant="outlined" label="Featured" clickable={true} style={(lastFilter==="Featured") ? chipStyleSelected : chipStyle} onClick={()=>filter("Featured","Featured")}/>
        ...
        <Chip className="filterProjects" id="Web Dev" variant="outlined" label="Web Dev" clickable={true} style={(lastFilter==="Web Dev") ? chipStyleSelected : chipStyle} onClick={()=>filter("Web-Dev","Web Dev")}/>
        <Chip className="filterProjects" id="Startups" variant="outlined" label="Startups" clickable={true} style={(lastFilter==="Startups") ? chipStyleSelected : chipStyle} onClick={()=>filter("Startups","Startups")}/>
        <Chip className="filterProjects" id="Digital Art" variant="outlined" label="Digital Art" clickable={true} style={(lastFilter==="Digital Art") ? chipStyleSelected : chipStyle} onClick={()=>filter("Digital Art","Digital Art")}/>
        <Chip className="filterProjects" id="Traditional Art" variant="outlined" label="Traditional Art" clickable={true} style={(lastFilter==="Traditional Art") ? chipStyleSelected : chipStyle} onClick={()=>filter("Traditional Art","Traditional Art")}/>
        <Chip className="filterProjects" id="Professional" variant="outlined" label="Professional" clickable={true} style={(lastFilter==="Professional") ? chipStyleSelected : chipStyle} onClick={()=>filter("Professional","Professional")}/>
        <Chip className="filterProjects" id="Hackathons" variant="outlined" label="Side Projects" clickable={true} style={(lastFilter==="Hackathons") ? chipStyleSelected : chipStyle} onClick={()=>filter("Hackathon","Hackathons")}/>
      </Grid>
      <Grid container direction="row" justify="center" style={{marginTop: '1vh'}}>
        <Link href="/startups/crave">
          <Grid className="item" id="Web-Dev, Startups, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/art/dancing-on-the-moon">
          <Grid className="item" id="Traditional Art, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/startups/pride-for-labour">
          <Grid className="item" id="Startups" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/art/cartoon-portrait">
          <Grid className="item" id="Digital Art" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/art/manifesto">
          <Grid className="item" id="Digital Art, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/tech/portfolio">
          <Grid className="item" id="Web-Dev, Digital Art, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/art/quilling">
          <Grid className="item" id="Startups, Traditional Art" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/tech/schedule-generator">
          <Grid className="item" id="Hackathon, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/art/circle-of-light">
          <Grid className="item" id="Traditional Art" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/work/ispirt">
          <Grid className="item" id="Professional, Featured" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/tech/first-robotics-competition">
          <Grid className="item" id="Hackathon" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
        ...
        <Link href="/work/mcdonald">
          <Grid className="item" id="Professional" item xs={10} sm={5} md={3} style={{backgroundColor: 'white', padding: '2.5vh 2.5vw 2.5vh 2.5vw', 'borderRadius': '15px', 'marginRight': '1vw', 'marginLeft': '1vw', cursor: 'pointer', marginBottom: '2vh'}}>
